...
public class GradleDependencyMetadata implements ModuleDependencyMetadata, ForcingDependencyMetadata {
    ...
    private GradleDependencyMetadata(ModuleComponentSelector selector, List<ExcludeMetadata> excludes, boolean pending, String reason, boolean force) {
    ...
    public GradleDependencyMetadata(ModuleComponentSelector selector, List<ExcludeMetadata> excludes, boolean pending, String reason) {
        this(selector, excludes, pending, reason, false);
    }
    ...
    public ModuleDependencyMetadata withRequestedVersion(VersionConstraint requestedVersion) {
        ...
        return new GradleDependencyMetadata(DefaultModuleComponentSelector.newSelector(selector.getModuleIdentifier(), requestedVersion, selector.getAttributes()), excludes, pending, reason, force);
    }
    ...
    public ModuleDependencyMetadata withReason(String reason) {
        ...
        return new GradleDependencyMetadata(selector, excludes, pending, reason, force);
    }

    @Override
    public DependencyMetadata withTarget(ComponentSelector target) {
        if (target instanceof ModuleComponentSelector) {
            return new GradleDependencyMetadata((ModuleComponentSelector) target, excludes, pending, reason, force);
        }
